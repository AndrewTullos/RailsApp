...
function Hero() {
	return (
		<main className="flex-1">
			{/* HERO */}
			<section className="py-20 md:py-32 bg-gradient-to-b from-white to-transparent">
			...
			{/* Testimonials */}
			<section id="testimonials" className="py-20 bg-amber-300">
				<div className="container">
			...
			<section
				id="cta"
				className="py-20 bg-transparent text-primary-foreground"
			>
