...
ALTER TABLE `user_clip` ADD CONSTRAINT `user_clip_fk1` FOREIGN KEY (`user_id`) REFERENCES `user_profile`(`id`);
ALTER TABLE `comment` ADD CONSTRAINT `comment_fk1` FOREIGN KEY (`comment_user_id`) REFERENCES `user_profile`(`id`);

ALTER TABLE `comment` ADD CONSTRAINT `comment_fk2` FOREIGN KEY (`clip_id`) REFERENCES `user_clip`(`id`);
ALTER TABLE `like` ADD CONSTRAINT `like_fk1` FOREIGN KEY (`user_id`) REFERENCES `user_profile`(`id`);

ALTER TABLE `like` ADD CONSTRAINT `like_fk2` FOREIGN KEY (`clip_id`) REFERENCES `user_clip`(`id`);
ALTER TABLE `follow` ADD CONSTRAINT `follow_fk1` FOREIGN KEY (`follower_id`) REFERENCES `user_profile`(`id`);

ALTER TABLE `follow` ADD CONSTRAINT `follow_fk2` FOREIGN KEY (`followee_id`) REFERENCES `user_profile`(`id`);
...
begin
    ...
    insert into `user_clip` (user_id, media_url, caption, created_at)
        ...
        (1, 'testMediaUrl2.com', 'testCaption2', '2020-01-01 00:00:00'),
